...
<html>
	...
	<head>
		...
		<title>House Of Indonesia USA</title>	



		<meta name="keywords" content="House Of Indonesia USA" />

		<meta name="description" content="House Of Indonesia USA">

		<meta name="author" content="House Of Indonesia USA">
	...
	<body data-plugin-cursor-effect>
		...
		<div class="body">
												...
												<li class="nav-item py-2 d-inline-flex z-index-1">
													...
													<span class="d-flex align-items-center p-0">
														...
														<span>
															...
															<img width="25" src="img/business-consulting-3/icons/phone.svg" alt="Phone Icon" data-icon data-plugin-options="{'onlySVG': true, 'extraClass': 'svg-fill-color-light'}" />

														</span>

														<a class="text-color-light text-decoration-none font-weight-semibold text-3-5 ms-2" href="tel:+17033952570" data-cursor-effect-hover="plus" data-cursor-effect-hover-color="light">+1(703)3952570</a>
													...
													<span class="font-weight-normal align-items-center px-0 d-none d-xl-flex ms-3">
														...
														<span>
															...
															<img width="25" src="img/business-consulting-3/icons/email.svg" alt="Email Icon" data-icon data-plugin-options="{'onlySVG': true, 'extraClass': 'svg-fill-color-light'}" />

														</span>

														<a class="text-color-light text-decoration-none font-weight-semibold text-3-5 ms-2" href="mailto:info@houseofindonesiausa.com" data-cursor-effect-hover="plus" data-cursor-effect-hover-color="light">info@houseofindonesiausa.com</a>
								...
								<div class="header-row">
									...
									<div class="header-logo">
										...
										<a href="index.php">
											...
											<img alt="Porto" width="162" height="33" src="img/business-consulting-3/logo.png">
												...
												<!--	<li class="dropdown">
														...
														<ul class="dropdown-menu">
															...
															<li>
																...
																<a href="service.php" class="dropdown-item">Sales & Marketing</a>

															</li>

															<li>

																<a href="service-a.php" class="dropdown-item">Strategic Planning</a>

															</li>

															<li>

																<a href="service-a.php" class="dropdown-item">Operations</a>

															</li>

															<li>

																<a href="service-a.php" class="dropdown-item">Cost Transformation</a>

															</li>

															<li>

																<a href="service-a.php" class="dropdown-item">Digital Marketing</a>

															</li>

															<li>

																<a href="service-a.php" class="dropdown-item">Automation</a>
													...
													<li class="d-lg-none">
														...
														<a class="nav-link" href="contac.php">
			...
			<div role="main" class="main">
				...
				<section class="section section-height-3 section-with-shape-divider position-relative border-0 m-0" data-plugin-parallax data-plugin-options="{'speed': 1.5, 'parallaxHeight': '120%'}" data-image-src="img/business-consulting-3/backgrounds/background-1.jpg">

					<img src="img/business-consulting-3/backgrounds/background-woman.png" class="img-fluid position-absolute top-0 right-0 d-none d-md-block appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="1100" alt="" />
					...
					<div class="container pb-5 pb-xl-0 mt-md-3 mb-5">
						...
						<div class="row pb-5 mb-5">
							...
							<div class="col-md-7 col-xl-5 pb-5 pb-xl-0 mb-5">
								...
								<strong class="d-block font-weight-semibold text-color-dark text-5-5 line-height-4 mb-3 pb-1 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="500">ZZZ Accelerate Strategy Execution and Consistency in <span class="custom-highlight-text-1 font-weight-bold">Revenue Growth!</span></strong>
								...
								<a href="#aboutus" data-hash data-hash-offset="100" class="d-inline-flex align-items-center text-decoration-none appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="1000">
									...
									<img width="30" height="30" src="img/business-consulting-3/icons/mouse.svg" alt="" data-icon data-plugin-options="{'onlySVG': true, 'extraClass': 'svg-fill-color-primary me-2'}" />
									...
									<a href="demo-business-consulting-3-services.html" class="custom-link-hover-effects text-decoration-none" data-cursor-effect-hover="plus">
										...
										<div class="card border-0">
											...
											<div class="card-body text-center py-5">
												...
												<img width="75" height="75" src="img/business-consulting-3/icons/blackboard.svg" alt="" data-icon data-plugin-options="{'onlySVG': true, 'extraClass': 'svg-fill-color-primary'}" style="width: 75px; height: 75px;" />

												<div class="custom-crooked-line">

													<img width="154" height="26" src="img/business-consulting-3/icons/infinite-crooked-line.svg" alt="" data-icon data-plugin-options="{'onlySVG': true, 'extraClass': 'svg-fill-color-primary'}" style="width: 154px; height: 26px;" />
												...
												<span class="custom-view-more d-inline-flex font-weight-medium text-color-primary">
													...
													<img width="27" height="27" src="img/business-consulting-3/icons/arrow-right.svg" alt="" data-icon data-plugin-options="{'onlySVG': true, 'extraClass': 'svg-fill-color-primary ms-2'}" style="width: 27px;" />
									...
									<a href="demo-business-consulting-3-services.html" class="custom-link-hover-effects text-decoration-none" data-cursor-effect-hover="plus">
										...
										<div class="card border-0">
											...
											<div class="card-body text-center py-5">
												...
												<img width="75" height="75" src="img/business-consulting-3/icons/weight-balance.svg" alt="" data-icon data-plugin-options="{'onlySVG': true, 'extraClass': 'svg-fill-color-primary'}" style="width: 75px; height: 75px;" />
						...
						<div class="col-md-10 col-lg-6 mb-5 mb-lg-0">
							...
							<div class="row row-gutter-sm">
								...
								<div class="col-6">
									...
									<img src="img/business-consulting-3/generic/generic-1.jpg" class="img-fluid box-shadow-5" alt="" />

								</div>

								<div class="col-6">

									<img src="img/business-consulting-3/generic/generic-2.jpg" class="img-fluid box-shadow-5 mb-4" alt="" />

									<img src="img/business-consulting-3/generic/generic-3.jpg" class="img-fluid box-shadow-5" alt="" />
							...
							<div class="row align-items-center pb-2 mb-4 mb-lg-1 mb-xl-4 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="750">
								...
								<div class="col-5">
									...
									<div class="d-flex">
										...
										<img width="63" height="63" src="img/business-consulting-3/icons/label.svg" alt="" data-icon data-plugin-options="{'onlySVG': true, 'extraClass': 'd-lg-none d-xl-block'}" />
								...
								<a href="demo-business-consulting-3-services-detail.html" class="custom-link-hover-effects text-decoration-none" data-cursor-effect-hover="plus">
									...
									<div class="card box-shadow-4">
										...
										<div class="card-img-top position-relative overlay overlay-show">
											...
											<div class="position-absolute bottom-0 left-0 w-100 py-3 px-4 z-index-3">
												...
												<div class="custom-crooked-line">
													...
													<img width="154" height="26" src="img/business-consulting-3/icons/infinite-crooked-line.svg" alt="" data-icon data-plugin-options="{'onlySVG': true, 'extraClass': 'svg-fill-color-primary'}" style="width: 154px;" />

												</div>

											</div>

											<img src="img/business-consulting-3/services/services-1.jpg" class="img-fluid" alt="Card Image" />
										...
										<div class="card-body d-flex align-items-center custom-view-more px-4">
											...
											<img width="50" height="50" class="w-auto" src="img/business-consulting-3/icons/arrow-right.svg" alt="" data-icon data-plugin-options="{'onlySVG': true, 'extraClass': 'svg-fill-color-primary'}" style="width: 50px;" />
								...
								<a href="demo-business-consulting-3-services-detail.html" class="custom-link-hover-effects text-decoration-none" data-cursor-effect-hover="plus">
									...
									<div class="card box-shadow-4">
										...
										<div class="card-img-top position-relative overlay overlay-show">
											...
											<img src="img/business-consulting-3/services/services-2.jpg" class="img-fluid" alt="Card Image" />
								...
								<a href="demo-business-consulting-3-services-detail.html" class="custom-link-hover-effects text-decoration-none" data-cursor-effect-hover="plus">
									...
									<div class="card box-shadow-4">
										...
										<div class="card-img-top position-relative overlay overlay-show">
											...
											<img src="img/business-consulting-3/services/services-3.jpg" class="img-fluid" alt="Card Image" />
								...
								<a href="demo-business-consulting-3-services-detail.html" class="custom-link-hover-effects text-decoration-none" data-cursor-effect-hover="plus">
									...
									<div class="card box-shadow-4">
										...
										<div class="card-img-top position-relative overlay overlay-show">
											...
											<img src="img/business-consulting-3/services/services-4.jpg" class="img-fluid" alt="Card Image" />
								...
								<a href="demo-business-consulting-3-services-detail.html" class="custom-link-hover-effects text-decoration-none" data-cursor-effect-hover="plus">
									...
									<div class="card box-shadow-4">
										...
										<div class="card-img-top position-relative overlay overlay-show">
											...
											<img src="img/business-consulting-3/services/services-5.jpg" class="img-fluid" alt="Card Image" />
								...
								<a href="demo-business-consulting-3-services-detail.html" class="custom-link-hover-effects text-decoration-none" data-cursor-effect-hover="plus">
									...
									<div class="card box-shadow-4">
										...
										<div class="card-img-top position-relative overlay overlay-show">
											...
											<img src="img/business-consulting-3/services/services-6.jpg" class="img-fluid" alt="Card Image" />
				...
				<section class="section section-height-4 section-with-shape-divider position-relative bg-dark border-0 m-0">
					...
					<div class="position-absolute top-0 left-0 h-100 d-none d-lg-block overlay overlay-show overlay-color-primary" data-plugin-parallax data-plugin-options="{'speed': 1.5}" data-image-src="img/business-consulting-3/parallax/parallax-1.jpg" style="width: 40%;"></div>
				...
				<div class="container">
					...
					<div class="row align-items-center py-4 my-5 mb-lg-0 my-xl-5">
						...
						<div class="col-lg-5">
							...
							<img src="img/business-consulting-3/generic/generic-4.jpg" class="img-fluid" alt="" />
										...
										<a href="demo-business-consulting-3-team.html#john" class="custom-link-hover-effects text-decoration-none" data-cursor-effect-hover="plus">
											...
											<div class="card border-0">
												...
												<div class="card-img-top position-relative overlay">
													...
													<img src="img/business-consulting-3/team/team-1.jpg" class="img-fluid" alt="John Doe" />
										...
										<a href="demo-business-consulting-3-team.html#robert" class="custom-link-hover-effects text-decoration-none" data-cursor-effect-hover="plus">
											...
											<div class="card border-0">
												...
												<div class="card-img-top position-relative overlay">
													...
													<img src="img/business-consulting-3/team/team-2.jpg" class="img-fluid" alt="John Doe" />
										...
										<a href="demo-business-consulting-3-team.html#jessica" class="custom-link-hover-effects text-decoration-none" data-cursor-effect-hover="plus">
											...
											<div class="card border-0">
												...
												<div class="card-img-top position-relative overlay">
													...
													<img src="img/business-consulting-3/team/team-3.jpg" class="img-fluid" alt="John Doe" />
										...
										<a href="demo-business-consulting-3-team.html#monica" class="custom-link-hover-effects text-decoration-none" data-cursor-effect-hover="plus">
											...
											<div class="card border-0">
												...
												<div class="card-img-top position-relative overlay">
													...
													<img src="img/business-consulting-3/team/team-4.jpg" class="img-fluid" alt="John Doe" />
										...
										<a href="demo-business-consulting-3-team.html#chris" class="custom-link-hover-effects text-decoration-none" data-cursor-effect-hover="plus">
											...
											<div class="card border-0">
												...
												<div class="card-img-top position-relative overlay">
													...
													<img src="img/business-consulting-3/team/team-5.jpg" class="img-fluid" alt="John Doe" />
				...
				<section class="section section-with-shape-divider position-relative bg-dark border-0 m-0">
					...
					<div class="position-absolute top-0 right-0 overlay overlay-show overlay-color-primary overlay-op-9 h-100 lazyload d-none d-md-block" data-bg-src="img/business-consulting-3/backgrounds/background-2.jpg" style="width: 32%; background-size: cover; background-position: center;"></div>
				...
				<section class="section section-height-3 border-0 m-0 lazyload" data-bg-src="img/business-consulting-3/backgrounds/background-3.jpg">
								...
								<div class="owl-carousel owl-theme custom-nav-style-1 nav-style-1 nav-svg-arrows-1 nav-outside custom-dots-style-2 bg-light box-shadow-4 mb-0" data-plugin-options="{'responsive': {'0': {'items': 1, 'dots': true}, '768': {'items': 1}, '992': {'items': 1, 'nav': true, 'dots': false}, '1200': {'items': 1, 'nav': true, 'dots': false}}, 'loop': false, 'autoHeight': true}">
									...
									<div class="py-5 px-lg-5">
										...
										<div class="testimonial testimonial-style-2 px-4 mx-xl-5 my-3">
											...
											<img width="40" height="40" src="img/business-consulting-3/icons/left-quote.svg" alt="" data-icon data-plugin-options="{'onlySVG': true, 'extraClass': 'svg-fill-color-primary'}" style="width: 40px;" />
							...
							<a href="demo-business-consulting-3-blog-post.html" class="custom-link-hover-effects text-decoration-none" data-cursor-effect-hover="plus">
								...
								<div class="card border-0 box-shadow-4">
									...
									<div class="card-img-top position-relative overlay">
										...
										<img src="img/business-consulting-3/blog/blog-1.jpg" class="img-fluid" alt="Lorem Ipsum Dolor" />
							...
							<a href="demo-business-consulting-3-blog-post.html" class="custom-link-hover-effects text-decoration-none" data-cursor-effect-hover="plus">
								...
								<div class="card border-0 box-shadow-4">
									...
									<div class="card-img-top position-relative overlay">
										...
										<img src="img/business-consulting-3/blog/blog-2.jpg" class="img-fluid" alt="Lorem Ipsum Dolor" />
							...
							<a href="demo-business-consulting-3-blog-post.html" class="custom-link-hover-effects text-decoration-none" data-cursor-effect-hover="plus">
								...
								<div class="card border-0 box-shadow-4">
									...
									<div class="card-img-top position-relative overlay">
										...
										<img src="img/business-consulting-3/blog/blog-3.jpg" class="img-fluid" alt="Lorem Ipsum Dolor" />
			...
			<footer id="footer" class="border-top-0 m-0 lazyload" data-bg-src="img/business-consulting-3/backgrounds/background-4.jpg" style="background-size: cover; background-position: center; background-repeat: no-repeat;">
				...
				<div class="container pt-3">
					...
					<div class="row justify-content-between align-items-center py-5 mb-3">
						...
						<div class="col-auto mb-4 mb-lg-0">
							...
							<h2 class="font-weight-semibold text-color-light text-10 ls-0 mb-0">Barma International</h2>
					...
					<div class="row pt-3 mt-5">
						...
						<div class="col-lg-3 mb-4 mb-lg-0">
							...
							<a href="index.php" class="text-decoration-none">
								...
								<img src="img/business-consulting-3/logo-footer.png" class="img-fluid mb-4" width="123" height="33" alt="" />
					...
					<!--		<ul class="social-icons social-icons-clean social-icons-clean-with-border social-icons-medium social-icons-icon-light">
								...
								<li class="social-icons-instagram mx-2"><a href="http://www.instagram.com/" target="_blank" title="Twitter" data-cursor-effect-hover="fit"><i class="fab fa-twitter"></i></a></li>
						...
						<div class="col-lg-3 mb-4 mb-lg-0">
							...
							<ul class="list list-icons list-icons-lg">
								...
								<li class="d-flex px-0 mb-1">
									...
									<a href="tel:+17033952570" class="text-color-light font-weight-semibold text-3-4 ms-2">+1(703)3952570</a>
								...
								<li class="d-flex px-0 my-3">
									...
									<a href="mailto:info@houseofindonesiausa.com" class="text-color-light font-weight-semibold text-3-4 ms-2">info@houseofindonesiausa.com</a>

								</li>

								<li class="d-flex font-weight-semibold text-color-light px-0 mb-1">

									<img width="25" src="img/business-consulting-3/icons/map-pin.svg" alt="Location" data-icon data-plugin-options="{'onlySVG': true, 'extraClass': 'svg-fill-color-light me-2'}" />
						...
						<div class="col-lg-2">
							...
							<ul class="list list-icons list-icons-sm">
								...
								<li>
									...
									<a href="service.php" class="link-hover-style-1 ms-1"> Our Services</a>
				...
				<div class="footer-copyright container bg-transparent">
					...
					<div class="row pb-5">
						...
						<div class="col-lg-12 text-center m-0">
							...
							<p class="text-3-4">Barma International © 2022. All Rights Reserved</p>
			...
			function initializeGoogleMaps() {
				...
				var mapMarkers = [{
					...
					icon: {
						...
						image: "img/business-consulting-3/map-pin.png",
